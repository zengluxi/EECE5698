...
% Load images.
buildingDir = fullfile('/home/lucy/TOOLBOX_calib/Undistort_15');
buildingScene = imageSet(buildingDir);

% Display images to be stitched
montage(buildingScene.ImageLocation)

%% Step 2 - Register Images Pairs 
...
% Initialize features for I(1)clc
grayImage = rgb2gray(I);

% points = detectSURFFeatures(grayImage);

[y,x] = harris(grayImage,1000,'tile',[0.1 0.1],'disp');
